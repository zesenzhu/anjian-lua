...
> 来源: https://res.anjian.com/uiDynamic/create/AddButton.html
...
ret = UI.AddButton(layoutName,eleName,text,width,height)
...
//添加一个名称为"按钮1"，初始内容为"这是个按钮"的按钮控件
TracePrint UI.AddButton("layout1", "按钮1", "这是个按钮") 
//显示名称为："layout1" 的布局控件
