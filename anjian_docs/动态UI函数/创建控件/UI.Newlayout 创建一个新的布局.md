# UI.Newlayout 创建一个新的布局

> 来源: https://res.anjian.com/uiDynamic/create/Newlayout.html
...
ret = UI.Newlayout(layoutName,style,width,height)
