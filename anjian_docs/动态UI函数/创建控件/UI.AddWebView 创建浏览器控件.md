# UI.AddWebView 创建浏览器控件

> 来源: https://res.anjian.com/uiDynamic/create/AddWebView.html
...
ret = UI.AddWebView(layoutName,eleName,\_url,width,height)
...
TracePrint UI.AddWebView("layout1", "web_view", "http://www.anjian.com/")
//显示名称为："layout1" 的布局控件
