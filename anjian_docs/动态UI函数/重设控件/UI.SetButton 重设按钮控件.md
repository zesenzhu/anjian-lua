...
> 来源: https://res.anjian.com/uiDynamic/modify/SetButton.html
...
ret = UI.SetButton(eleName,text,width,height)
...
Function setEle()
    //重设名称为"按钮1"按钮控件，修改标题为"按钮被点击了"
    TracePrint UI.SetButton("按钮1", "按钮被点击了") 
End Function
```
