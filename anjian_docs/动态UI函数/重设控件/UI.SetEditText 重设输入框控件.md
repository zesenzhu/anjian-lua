# UI.SetEditText 重设输入框控件

> 来源: https://res.anjian.com/uiDynamic/modify/SetEditText.html
...
ret = UI.SetEditText(eleName,text,width,height)
...
Function setEle()
    //重设刚才添加的"输入框1"控件文字内容为："输入框被修改了"，宽高分别为200像素
    TracePrint UI.SetEditText("输入框1", "输入框被修改了", 200, 200)
End Function
```
