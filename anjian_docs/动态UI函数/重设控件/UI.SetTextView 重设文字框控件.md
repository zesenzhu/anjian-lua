# UI.SetTextView 重设文字框控件

> 来源: https://res.anjian.com/uiDynamic/modify/SetTextView.html
...
ret = UI.SetTextView(eleName,text,width,height)
...
Function setEle()
    //重设刚才添加的"文字框1"控件文字内容为："年龄："
    TracePrint UI.SetTextView("文字框1", "年龄：")
End Function
```
