...
> 来源: https://res.anjian.com/uiDynamic/modify/SetCheckBox.html
...
ret = UI.SetCheckBox(eleName,text,defaultValue,width,height)
...
| text | string | 是 | 初始显示文本内容 |
| defaultValue | bool | 否 | 默认是否选中，默认：false  
true：选中  
false：不选中 |
...
Function setEle()
    //重设刚才创建的多选框，更改多选框标题为"多选框1被修改了"并默认勾选状态
    TracePrint UI.SetCheckBox("check_box1","多选框1被修改了",True)
End Function
```
