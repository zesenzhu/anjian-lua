# UI.SetRadioGroup 重设单选框控件

> 来源: https://res.anjian.com/uiDynamic/modify/SetRadioGroup.html
...
ret = UI.SetRadioGroup(eleName,items,defaultValue,width,height)
...
Function setEle()
    //重设刚才创建的单选框组，更改单选框标题分别为：1大瓶，2中瓶，3小瓶并默认勾选第3个单选框
    TracePrint UI.SetRadioGroup("补血药品",{"1大瓶", "2中瓶", "3小瓶"},2)
End Function
```
