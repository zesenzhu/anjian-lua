# UI.GetTitleText 获取标题内容

> 来源: https://res.anjian.com/uiDynamic/property/GetTitleText.html
...
//修改其标题为："布局标题"
TracePrint UI.SetTitleText("layout1","布局标题")
...
Function getAttr()
    //获取布局标题
    TracePrint UI.GetTitleText("layout1")
End Function
```
