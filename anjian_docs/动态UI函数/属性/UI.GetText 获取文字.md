...
> 来源: https://res.anjian.com/uiDynamic/property/GetText.html
...
Function getAttr()
    //获取名称为"文字框1"控件的文本内容，输出："姓名："
    TracePrint UI.GetText("文字框1")
End Function
```

### 备注说明

此属性是通用的，文字、输入、按钮、单选、多选等控件都支持使用此属性获取文字
