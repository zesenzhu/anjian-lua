# UI.SetTextSize 设置文字大小

> 来源: https://res.anjian.com/uiDynamic/property/SetTextSize.html
...
ret = UI.SetTextSize(eleName,textSize)
...
Function setAttr()
    //设置"文字框1"的控件的文字字体大小为60号
    TracePrint UI.SetTextSize("文字框1", 60)
End Function
```

### 备注说明

此属性是通用的，布局、文字、输入、按钮、单选、多选等控件都支持使用此属性设置字体大小
