# UI.SetBackColor 设置背景颜色

> 来源: https://res.anjian.com/uiDynamic/property/SetBackColor.html
...
ret = UI.SetBackColor(eleName,backColor)
...
Function setAttr()
    //设置文字框1的背景颜色为蓝色
    TracePrint UI.SetBackColor("文字框1","E1833B")
End Function
```
