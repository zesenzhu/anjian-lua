# UI.SetTitleBackColor 设置标题栏背景颜色

> 来源: https://res.anjian.com/uiDynamic/property/SetTitleBackColor.html
...
ret = UI.SetTitleBackColor(layoutName,backColor)
...
Function setAttr()
    //设置"layout1"标题栏背景颜色为红色
    TracePrint UI.SetTitleBackColor("layout1","0000FF")
End Function
```
