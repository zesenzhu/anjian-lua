# UI.SetTitleText 设置布局标题

> 来源: https://res.anjian.com/uiDynamic/property/SetTitleText.html
...
ret = UI.SetTitleText(layoutName,text)
...
Function setAttr()
    //修改"layout1"布局标题为"UI界面"
    TracePrint UI.SetTitleText("layout1","UI界面")
End Function
```
