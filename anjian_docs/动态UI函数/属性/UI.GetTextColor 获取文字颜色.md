# UI.GetTextColor 获取文字颜色

> 来源: https://res.anjian.com/uiDynamic/property/GetTextColor.html
...
Function getAttr()
    //查看输出是否与前面设置的颜色一致
    TracePrint  UI.GetTextColor("文字框1")
End Function
```
