...
> 来源: https://res.anjian.com/uiDynamic/method/LoadProfile.html
...
| 参数名 | 参数类型 | 是否必选 | 参数说明 |
| --- | --- | --- | --- |
| cfgPath | string | 否 | 由UI.SaveProfile保存的配置文件所在的完整路径，默认为按键临时目录下的UiProFileTemp.txt |
