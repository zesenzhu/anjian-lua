...
> 来源: https://res.anjian.com/expand/opencv/FindImgBest.html
...
result = OpenCV.FindImgBest(left, top, right, bottom, imgs, sim\[, minScale, maxScale, stepCount,options\])
...
ranTime = TickCount()
ret = OpenCV.FindImgBest(0,0,0,0, picPath & "|Attachment:111.png|Attachment:222.png|Attachment:333.png|Attachment:444.png", 0.8, 0.9, 1.2, 10,{"isGray":true})
