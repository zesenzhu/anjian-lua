# Sys.WritePlist 写入并生成plist文件

> 来源: https://res.anjian.com/expand/sys/WritePlist.html
...
ret = sys.writePlist(filePath, content)

### 函数参数

| 参数名 | 参数类型 | 是否必选 | 参数说明 |
| --- | --- | --- | --- |
| filePath | string | 是 | 生成plist文件的路径 |
| content | table | 是 | 待写入的完整内容键值表 |
