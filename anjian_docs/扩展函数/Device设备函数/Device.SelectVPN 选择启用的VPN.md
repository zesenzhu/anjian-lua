# Device.SelectVPN 选择启用的VPN

> 来源: https://res.anjian.com/expand/device/SelectVPN.html
...
在系统设置已添加VPN连接中，选择指定的VPN作为启用VPN
...
result = Device.SelectVPN(VPNName)

### 函数参数

| 参数名 | 参数类型 | 是否必选 | 参数说明 |
| --- | --- | --- | --- |
| VPNName | string | 是 | 要选择启用的VPN名称 |
