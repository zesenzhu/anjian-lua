# Encode.TableToJson 将键值表转换成对应的Json字符串

> 来源: https://res.anjian.com/expand/encode/TableToJson.html

---

### 函数名称

Encode.TableToJson 将table转json
...
ret = Encode.TableToJson(table)

### 函数参数

| 参数名 | 参数类型 | 是否必选 | 参数说明 |
| --- | --- | --- | --- |
| table | table | 是 | 任意有效的键值表table |

### 函数返回

| 返回名 | 返回类型 | 返回说明 |
| --- | --- | --- |
| ret | string | 返回对应键值表转成的json字符串 |
