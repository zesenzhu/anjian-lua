...
> 来源: https://res.anjian.com/expand/utf8/InStr.html
...
ret = UTF8.InStr(startPosition,wholeString,searchString\[,comparision\])
...
For i = 1 To Len(wholeString)
    ret = UTF8.InStr(1,wholeString[i], searchString) //该函数中一个汉字占用1长度
    If ret > 0 Then
