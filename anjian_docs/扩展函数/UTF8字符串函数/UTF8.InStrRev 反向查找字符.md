...
> 来源: https://res.anjian.com/expand/utf8/InStrRev.html
...
ret = UTF8.InStrRev(wholeString,searchString,startPosition\[,comparision\])
...
For i = 1 To Len(wholeString)
    ret = UTF8.InStrRev(wholeString[i], searchString,-1) //该函数中一个汉字占用1长度
    If ret > 0 Then
