# Image.QrDecode 二维码图片解析

> 来源: https://res.anjian.com/expand/image/QrDecode.html

---

### 函数名称

Image.QrDecode 解析二维码图片
...
| 参数名 | 参数类型 | 是否必选 | 参数说明 |
| --- | --- | --- | --- |
| path | string | 是 | 需解析的二维码图片路径，支持jpg、png等格式 |

### 函数返回

| 返回名 | 返回类型 | 返回说明 |
| --- | --- | --- |
| ret | string | 解析二维码得到的字符串 |
