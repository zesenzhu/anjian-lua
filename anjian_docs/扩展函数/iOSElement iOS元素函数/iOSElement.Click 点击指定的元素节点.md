# iOSElement.Click 点击指定的元素节点

> 来源: https://res.anjian.com/expand//Click.html
...
点击指定的元素节点，支持完整目标元素节点或者元素查找条件，如查找到多个元素则只操作第一个元素
...
| 参数名 | 参数类型 | 是否必选 | 参数说明 |
| --- | --- | --- | --- |
| element | table | 是 | 完整目标元素节点或者元素查找条件 |
...
If result["code"] = 0 Then 
    result = iOSElement.Click(result["data"])
    If result["code"] = 0 Then 
        TracePrint "点击成功"
    Else
