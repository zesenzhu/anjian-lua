...
> 来源: https://res.anjian.com/expand//SelectPicker.html
...
| 参数名 | 参数类型 | 是否必选 | 参数说明 |
| --- | --- | --- | --- |
| selector | table | 是 | 完整目标元素节点或者元素查找条件 |
| col | int | 是 | 调整第几列的数据，从0开始 |
| row | int | 是 | 调整到第几行选项，从0开始 |
