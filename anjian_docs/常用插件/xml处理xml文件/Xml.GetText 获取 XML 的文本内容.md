# Xml.GetText 获取 XML 的文本内容

> 来源: https://res.anjian.com/plugin/xml/GetText.html
...
| 返回名 | 返回类型 | 返回说明 |
| --- | --- | --- |
| text | string | 返回 XML 的节点文本内容；没有节点文本时返回空字符 |
...
If xmlNode Then 
    ...
    If xmlNode Then 
        TracePrint "找到的节点的文本为：" & Xml.GetText(xmlNode)
    End If
End If
```
