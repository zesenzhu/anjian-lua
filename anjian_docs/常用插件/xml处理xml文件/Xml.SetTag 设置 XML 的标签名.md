# Xml.SetTag 设置 XML 的标签名

> 来源: https://res.anjian.com/plugin/xml/SetTag.html
...
If xmlNode Then 
    ...
    If xmlNode Then 
        ...
        Xml.SetTag(xmlNode, "newBook")
        TracePrint "修改后的标签名称为：" & Xml.GetTag(xmlNode)
    End If
End If
```
