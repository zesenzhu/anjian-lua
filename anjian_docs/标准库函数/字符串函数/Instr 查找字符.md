...
> 来源: https://res.anjian.com/standard/string/Instr.html
...
ret = InStr(startPosition,wholeString,searchString\[,comparision\])
...
For i = 1 To Len(wholeString)
    ret = InStr(1, wholeString[i], searchString) //该函数中一个汉字占用3长度
    If ret > 0 Then
